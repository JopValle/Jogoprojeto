def teste(sala):
    if sala == 'A1': #esquema de sala com duas op
        ...
        if resposta == 2:
            sala = 'A2'
        return sala
    if sala == 'B1K': #esquema de sala com 3 op
        print('-'*20)
        ...
        resposta = int(input('Digite aqui: '))
        if resposta == 1:
            sala = 'C1' #sala que possúi uma chave
        if resposta == 2:
            sala = 'B2'
        if resposta == 3:
            sala = 'A1'
    ...
    if sala == 'A2': #esquema de sala com 3 op
        ...
        if resposta == 3:
            sala = 'A3'
        return sala
    if sala == 'C2K': #esquema de sala com 3 op
        print('-'*20)
        ...
        if resposta == 3:
            sala = 'B2'
        return sala
    if sala == 'A3': #esquema de sala com duas op
        print('-'*20)
        ...
        if resposta == 2:
            sala = 'A2'
        return sala
    if sala == 'B3K': #esquema de sala com 3 op
        print('-'*20)
        ...
        if resposta == 3:
            sala = 'B2'
        return sala
    if sala == 'C3': #esquema de sala com duas op
        print('-'*20)
